...
function Feedback({ params }) {
    ...
    return (
        <div className='p-10'>
            ...
            :<>
            <h2 className='text-3xl text-green-400 font-bold'>Congratulation ! </h2>
            <h2 className='font-bold text-2xl'>Here is your Interview Feedback.</h2>
            {/* <h2 className='text-blue-400 text-lg my-3'>Your overall interview rating: <strong>7/10</strong></h2> */}
            <h2 className='text-sm text-gray-500'>Find below interview quetion with correct answer, Your answer and feedback for improvment</h2>
                ...
                <Collapsible key={index} className='my-5'>
                    ...
                    <CollapsibleContent>
                       <div className='flex flex-col gap-2'>
                        <h2 className='text-red-500 p-5 border rounded-lg'><strong>Rating : </strong>{item.rating}</h2>
